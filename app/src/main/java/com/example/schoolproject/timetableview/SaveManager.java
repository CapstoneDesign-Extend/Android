...
public class SaveManager {
    public static String saveSticker(HashMap<Integer, com.github.tlaabs.timetableview.Sticker> stickers){
        ...
        for(int i = 0 ; i < orders.length; i++){
            ...
            ArrayList<com.github.tlaabs.timetableview.Schedule> schedules = stickers.get(idx).getSchedules();
    ...
    public static HashMap<Integer, com.github.tlaabs.timetableview.Sticker> loadSticker(String json){
        ...
        for(int i = 0 ; i < arr1.size(); i++){
            ...
            for(int k = 0 ; k < arr2.size(); k++){
                com.github.tlaabs.timetableview.Schedule schedule = new Schedule();
                ...
                com.github.tlaabs.timetableview.Time startTime = new com.github.tlaabs.timetableview.Time();
                ...
                com.github.tlaabs.timetableview.Time endTime = new Time();
